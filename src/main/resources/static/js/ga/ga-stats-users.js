...
//     clear graph
    d3.select("#users-growth-graph").selectAll("*").remove();
...
// append the svg object to the body of the page
    const svg = d3.select("#users-growth-graph")
        .append("svg")
    ...
    d3.json("api/ga/users").then(
        ...
        function (data) {
            ...
            switch (userFilterType) {
                case userFilterTypes.DAY:
                    x = dayFilter();
                    break
                case userFilterTypes.WEEK:
                    x = weekFilter();
                    break
                case userFilterTypes.MONTH:
                    x = monthFilter();
                    break;
                case userFilterTypes.YEAR:
                    x = yearFilter();
                    break;
            }
