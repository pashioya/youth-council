...
@Controller
@AllArgsConstructor
@RequestMapping("/youth-councils/{id}/news-items")
public class NewsItemControllerMVC {
    ...
    @GetMapping
    public ModelAndView getAllNewsItems(@PathVariable long id){
        LOGGER.info("Getting all news items for youth council with id: " + id);
        List<NewsItem> newsItems = newsItemService.getNewsItemsByYouthCouncilId(id);
