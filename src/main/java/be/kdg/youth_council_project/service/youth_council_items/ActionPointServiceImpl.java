...
public class ActionPointServiceImpl implements ActionPointService {
    ...
    public ActionPoint getActionPointById(long youthCouncilId, long actionPointId) {
        ...
        LOGGER.info("find all" + actionPointRepository.findAll().stream().map(ActionPoint::getId).toList());
        LOGGER.info("Finding with id: " + actionPointId + " and youthCouncilId: " + youthCouncilId);
